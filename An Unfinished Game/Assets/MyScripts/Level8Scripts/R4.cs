...
public class R4 : MonoBehaviour
{
    ...
    public IEnumerator FirstWait()
    {
        ...
        GameObject monsterG2 = Instantiate(monster, new Vector3(this.transform.position.x + 18f, this.transform.position.y + 6f, this.transform.position.z), this.transform.rotation);
        StartCoroutine(Route(monsterG2, new Vector3(this.transform.position.x - 18f, this.transform.position.y + 6f, this.transform.position.z), 10f));
    }
