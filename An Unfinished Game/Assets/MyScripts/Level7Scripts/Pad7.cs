...
public class Pad7 : MonoBehaviour
{
    ...
    {
        if (other.gameObject.tag == "PurpleKey" && doorOpened == false && triggerIsDisabled == false)
        {
    ...
    {
        if (other.gameObject.tag == "PurpleKey" && triggerIsDisabled == false)
        {
            StartCoroutine(CollideDelay());
