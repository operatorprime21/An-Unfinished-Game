...
public class Y1 : MonoBehaviour
{
    ...
    void Start()
    {
        GameObject monsterG1 = Instantiate(monster, new Vector3(this.transform.position.x - 65f, this.transform.position.y + 6f, this.transform.position.z), this.transform.rotation);
        StartCoroutine(Route(monsterG1, new Vector3(this.transform.position.x + 65f, this.transform.position.y + 6f, this.transform.position.z), 10f));
    }
